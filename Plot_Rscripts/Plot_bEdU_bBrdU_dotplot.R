Plot_bEdU_bBrdU_dotplot <- function() {
  b <- ggplot(mydata, aes(x=factor(Genotype, levels=c("WT","Mut")), y=bEdU_bBrdU, color = Animal)) +
    ...
    ylab("basal EdU / basal BrdU") + xlab("Genotype") + ylim(0,4) 
